...
test("Preis und Titel vom Playstation 5 von Mediamarkt", async () => {
  ...
  const akzeptierenButton = await driver.findElement(
    By.xpath('//*[@id="pwa-consent-layer-accept-all-button"]/span')
  );
  ...
  const suchButton = await driver.findElement(
    By.xpath('//*[@id="storybook-form-1"]/div/div/div[1]/button')
  );
  ...
  await driver.wait(
    until.elementLocated(
      By.xpath(
        '//*[@id="main-content"]/div[1]/div[1]/div[2]/div/div[3]/div[1]/div/div/div/a/div/p'
      )
    ),
    10000
  );
  ...
  const price = await driver
    .findElement(
      By.xpath(
        '//*[@id="main-content"]/div[1]/div[1]/div[2]/div/div[3]/div[1]/div/div/div/div[4]/div/div/div[2]/span[1]'
      )
    )
    .getText();
